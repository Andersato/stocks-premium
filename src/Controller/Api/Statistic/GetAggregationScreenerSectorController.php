...
final class GetAggregationScreenerSectorController extends AppAbstractController
{
     ...
     */
    #[Route(path: '/api/statistics/screener/aggs/sectors', name: 'get_aggregations_screener_sectors', methods: ['POST'])]
