...
final class GetAggregationScreenerMarketCapController extends AppAbstractController
{
     ...
     */
    #[Route(path: '/api/statistics/screener/aggs/market-caps', name: 'get_aggregations_screener_market_caps', methods: ['POST'])]
