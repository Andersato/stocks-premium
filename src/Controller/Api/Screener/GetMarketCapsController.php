...
use App\Service\Screener\GetMarketCapsService;
...
final class GetMarketCapsController extends AppAbstractController
{
   public function __construct(
       private readonly GetMarketCapsService $getMarketCapsService,
   ...
   )
   {
     ...
     */
    #[Route(path: '/api/screener/market-caps', name: 'get_filter_market_caps', methods: ['GET'])]
    public function __invoke(): JsonResponse
    {

        $dataResponse = ($this->getMarketCapsService)();
